...
func (p *PrometheusConfig) AddGoFlags(fs *flag.FlagSet) {
...
func (p *PrometheusConfig) AddFlags(fs *pflag.FlagSet) {
...
func (p *PrometheusConfig) ToHTTPClientConfig() (*prom_config.HTTPClientConfig, error) {
...
func (p *PrometheusConfig) NewPrometheusClient() (promapi.Client, error) {
	if p.Addr == "" {
		return nil, nil
	}
